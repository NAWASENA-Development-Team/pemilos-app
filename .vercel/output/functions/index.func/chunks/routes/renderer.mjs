...
import { b as buildAssetsURL, a as publicAssetsURL, c as useRuntimeConfig, d as getResponseStatusText, e as getResponseStatus, f as encodePath, h as defineRenderHandler, i as getQuery, j as createError, k as destr, l as getRouteRules, m as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Pemilihan Ketua OSIS dan Wakil Ketua OSIS Peeriode 2026/2027"};
