import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { toRef, isRef, hasInjectionContext, getCurrentInstance, defineAsyncComponent, defineComponent, h, inject, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, withCtx, nextTick, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { n as parseURL, f as encodePath, o as decodePath, q as klona, j as createError$1, r as hasProtocol, s as isScriptProtocol, m as joinURL, w as withQuery, v as defuFn, x as sanitizeStatusCode, y as getContext, $ as $fetch$1, z as baseURL, A as defu, B as executeAsync, C as getHeader, D as setCookie, E as setHeader } from '../_/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    name: "success",
    path: "/success",
    component: () => import('./success-C99FOu-5.mjs')
  },
  {
    name: "vote",
    path: "/vote",
    component: () => import('./vote-CgcLA2RA.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BnH5g45V.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-CQQPKTjA.mjs').then((n) => n.i).then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DsYEVZkv.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Cp5aKSDt.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-A-SbA0mE.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useState as b, useRouter as c, useRuntimeConfig as d, entry_default as default, encodeRoutePath as e, fetchDefaults as f, nuxtLinkDefaults as g, useAppConfig as h, asyncDataDefaults as i, createError as j, navigateTo as n, resolveRouteObject as r, useRequestFetch as u };
